...
- Исправлен сброс настроек при закрытии и повторном открытии приложения.
- Добавлены presets: `Standard`, `TLS only`, `Aggressive`.
- Добавлена кнопка `Reset Arguments`.
- Добавлена диагностика: DNS, IPv6, сохраненные аргументы, последние запущенные аргументы, последний статус VPN и последняя ошибка.
